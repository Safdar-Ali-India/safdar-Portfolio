  ...
  return (
    <section className="mb-14">
      <div className="py-8 lg:pt-16 mx-auto max-w-screen-md">
        ...
        >
          <div>
            <label htmlFor="email" className="text-neutral-500 text-xs font-InterBold uppercase font-bold my-5">
              Your Email
            </label>
            <input type="email" name="email" id="email" className="block p-3 w-full text-sm light:text-gray-900 dark:bg-slate-50 dark:bg-neutral-800/20 rounded-lg border border-gray-300 dark:border-gray-600 shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:focus:text-black light:focus:text-black dark:placeholder-gray-400 dark:text-black dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="name@example.com" required />
          </div>
          <div>
            <label htmlFor="fullname" className="text-neutral-500 text-xs font-InterBold uppercase font-bold my-5">
              Full Name
            </label>
            <input type="text" name="fullname" id="fullname" className="block p-3 w-full text-sm light:text-gray-900 dark:bg-slate-50 dark:bg-neutral-800/20 rounded-lg border border-gray-300 dark:border-gray-600 shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:placeholder-gray-400 dark:text-black dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="John Doe" required />
          </div>
          <div className="sm:col-span-2">
            <label htmlFor="message" className="text-neutral-500 text-xs font-InterBold uppercase font-bold my-5">
              Your Message
            </label>
            <input name="message" type="text" id="message" rows="6" className="block p-2.5 w-full text-sm light:text-gray-900 dark:bg-slate-50 dark:bg-neutral-800/20 rounded-lg shadow-sm border border-gray-300 dark:border-gray-600 focus:ring-primary-500 focus:border-primary-500 dark:placeholder-gray-400 dark:text-black dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="Can you help me ship this project?..."></input>
          </div>
